    ...
    return (
        <>
            ...
            <main className="bg-slate-900 mt-10 p-12 rounded-xl max-w-lg m-auto">
                <h2 className="text-2xl font-bold">Cadastrar Despesa</h2>
                <form action={handleSubmit}>
                    <InputText name="categoria_id" id="categoriaId" label="categoria id" />
                    <InputText name="valor" id="valor" label="valor" type="number" inputmode="decimal" />
                    <InputText name="quantidade" id="quantidade" label="quantidade" />

                    <div className="flex justify-around mt-4">
                        <Button href="/despesa" variant="secundary" icon={<ArrowLeftIcon className="h-6 w-6" />}>
                            cancelar
                        </Button>
